...
{   
    ...
    public GameObject zombieHeadPrefeb;
    ...
    public void TranssitionToPause()
    {
    ...
    public void TakeDamage(int damage)
    {
        ...
        {
            haveHead = false;
            GameObject go = GameObject.Instantiate(zombieHeadPrefeb, transform.position,Quaternion.identity);
            Destroy(go,2);
        }
