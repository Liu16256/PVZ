...
public class GameManager : MonoBehaviour
{
    ...
    public FailUI failUI;public WinUI winUI;
    ...
    void GameStart()
    {
        ...
        Camera.main.transform.DOPath(
            new Vector3[] { currentPosition,new Vector3(4,0,-10),currentPosition},4,PathType.Linear).OnComplete(OnCameraMoveComplete);
    }
